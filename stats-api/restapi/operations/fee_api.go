...
func NewFeeAPI(spec *loads.Document) *FeeAPI {
	return &FeeAPI{
		...
		GetFeeMultiplierProducerHandler: GetFeeMultiplierProducerHandlerFunc(func(params GetFeeMultiplierProducerParams) middleware.Responder {
			return middleware.NotImplemented("operation GetFeeMultiplierProducer has not yet been implemented")
		}),
		...
		GetSuggestFeevoteHandler: GetSuggestFeevoteHandlerFunc(func(params GetSuggestFeevoteParams) middleware.Responder {
			return middleware.NotImplemented("operation GetSuggestFeevote has not yet been implemented")
		}),
		GetSuggestSetfeemultHandler: GetSuggestSetfeemultHandlerFunc(func(params GetSuggestSetfeemultParams) middleware.Responder {
			return middleware.NotImplemented("operation GetSuggestSetfeemult has not yet been implemented")
		}),
	}
}
...
func (o *FeeAPI) Validate() error {
	...
	if o.GetFeeMultiplierProducerHandler == nil {
		unregistered = append(unregistered, "GetFeeMultiplierProducerHandler")
	}
	...
	if o.GetSuggestFeevoteHandler == nil {
		unregistered = append(unregistered, "GetSuggestFeevoteHandler")
	}
	if o.GetSuggestSetfeemultHandler == nil {
		unregistered = append(unregistered, "GetSuggestSetfeemultHandler")
	}
...
func (o *FeeAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/fee/multiplier/{producer}"] = NewGetFeeMultiplierProducer(o.context, o.GetFeeMultiplierProducerHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/suggest/feevote"] = NewGetSuggestFeevote(o.context, o.GetSuggestFeevoteHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/suggest/setfeemult"] = NewGetSuggestSetfeemult(o.context, o.GetSuggestSetfeemultHandler)
}
