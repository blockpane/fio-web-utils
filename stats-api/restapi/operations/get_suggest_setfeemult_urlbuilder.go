...
func (o *GetSuggestSetfeemultURL) Build() (*url.URL, error) {
	...
	var targetQ string
	if o.Target != nil {
		targetQ = swag.FormatFloat64(*o.Target)
	}
	if targetQ != "" {
...
func (o *GetSuggestSetfeemultURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSuggestSetfeemultURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSuggestSetfeemultURL")
	}
