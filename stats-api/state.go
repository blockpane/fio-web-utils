...
type feeState struct {
	...
	FeeVotes        []*FeeVote2 `json:"fee_votes"`
	...
	// Fees holds the contents of the fio.fee::fiofees table
...
// There is a bug in fio-go, with the wrong tag: has fee_votes, not feevotes, this is a workaround:
